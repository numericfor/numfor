subroutine cocosp(m, x, y, w, n, t, e, maxtr, maxbin, c, sq, sx, bind, wrk, lwrk, iwrk, kwrk, ier)
  ...
  logical bind(n)
  !  ..local scalars..
  integer :: i, ia, ib, ic, iq, iu, iz, izz, ji, jib, jjb, jl, jr, ju, kwest, lwest, mb, nm, n6
  real(8) :: one
  !  ..
  !  set constant
  one = 0.1e+01
